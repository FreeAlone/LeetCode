...
public class LC_0210 {
    ...
    public static void main(String[] args) {
        ...
        int numCourses3 = 1;
        int[][] prerequisites3 = {};
        LC_0210 lc_0210 = new LC_0210();
        LC_Utils.printArr(lc_0210.findOrder(numCourses1, prerequisites1));
        LC_Utils.printArr(lc_0210.findOrder(numCourses2, prerequisites2));
        LC_Utils.printArr(lc_0210.findOrder(numCourses3, prerequisites3));
    }
