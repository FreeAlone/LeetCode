...
public class LC_0219 {
    ...
    public static void main(String[] args) {
        ...
        int k3 = 2;
        LC_0219 lc_0219 = new LC_0219();
        System.out.println(lc_0219.containsNearbyDuplicate(nums1, k1));
        System.out.println(lc_0219.containsNearbyDuplicate(nums2, k2));
        System.out.println(lc_0219.containsNearbyDuplicate(nums3, k3));
    }
