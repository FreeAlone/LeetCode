...
public class LC_0240 {
    ...
    public static void main(String[] args) {
        ...
        int target2 = 20;
        LC_0240 lc_0240 = new LC_0240();
        System.out.println(lc_0240.searchMatrix(matrix, target));
        System.out.println(lc_0240.searchMatrix(matrix1, target1));
        System.out.println(lc_0240.searchMatrix(matrix2, target2));
    }
