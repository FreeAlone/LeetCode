...
public class LC_0994 {

    public static void main(String[] args) {
        int[][] grid1 = {{2,1,1},{1,1,0},{0,1,1}};
        int[][] grid2 = {{2,1,1},{0,1,1},{1,0,1}};
        int[][] grid3 = {{0,2}};
        LC_0994 lc_0994 = new LC_0994();
        System.out.println(lc_0994.orangesRotting(grid1));
        System.out.println(lc_0994.orangesRotting(grid2));
        System.out.println(lc_0994.orangesRotting(grid3));
    }
