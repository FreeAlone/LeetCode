...
public class LC_0101 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lc_0101.isSymmetric(LC_Utils.arrayToTree(nums)));
        System.out.println(lc_0101.isSymmetric2(LC_Utils.arrayToTree(nums)));
        System.out.println(lc_0101.isSymmetric(LC_Utils.arrayToTree(nums2)));
        System.out.println(lc_0101.isSymmetric2(LC_Utils.arrayToTree(nums2)));
    }
