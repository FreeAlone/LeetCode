...
public class LC_0139 {
    ...
    public static void main(String[] args) {
        ...
        LC_0139 lc_0139 = new LC_0139();
        System.out.println(lc_0139.wordBreak(s1, wordDict1));
        System.out.println(lc_0139.wordBreak(s2, wordDict2));
        System.out.println(lc_0139.wordBreak(s3, wordDict3));
        System.out.println(lc_0139.wordBreak(s4, wordDict4));
    }
