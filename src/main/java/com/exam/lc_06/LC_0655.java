...
public class LC_0655 {

    public static void main(String[] args) {
        LC_0655 lc_0655 = new LC_0655();

        TreeNode treeNode1 = new TreeNode(1);
        treeNode1.left = new TreeNode(2);
        List<List<String>> result = lc_0655.printTree(treeNode1);
        LC_Utils.printListList(result);
        ...
        LC_Utils.printListList(lc_0655.printTree(t));
        LC_Utils.printListList(lc_0655.printTree2(t));
    }
